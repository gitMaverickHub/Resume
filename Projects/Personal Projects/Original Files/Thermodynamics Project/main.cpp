...
//Waiting for the values to be put into the Input.csv file before continuing
    ...
    cout << "\nAn Input.csv file was created in the current directory if it did not already exist.\n"
         << "Put the desired input values into their respective locations in the 3rd row of the Input.csv file.\n"
         ...
         << "Are the desired values in the Input.csv file? [Y/N]\n\n"
    ...
    while (1) {
        ...
        if (continueString == "Y") {
            ...
            cout << "Enter 'Y' for yes to continue.\n";
        }
    }
    ...
    while (!stopBool) {
        ...
        while(1) {
                ...
                0 < stod(column_data[10]) && stod(column_data[10]) <= 1) 
            {
                ...
                string readyString;
                while(!readyBool) {
                    cout <<"Enter 'r' for ready for when the values have been put in correctly to continue the program.\n";
                    cin >> readyString;
